    ...
    <div className="grid md:grid-cols-2 gap-10 items-center py-24">
      ...
      <div className="text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="#services"
            className="bg-white text-primary hover:opacity-90 rounded-xl px-6 py-3 font-semibold"
          >
            Explore Services
          </a>
          ...
          <a
            href="#contact"
            className="border border-white/80 text-white hover:bg-white/10 rounded-xl px-6 py-3 font-semibold"
          >
...
<footer className="bg-primary text-white">
    ...
    <div>
      ...
      <form className="space-y-3">
        ...
        <input
          ...
          placeholder="Phone"
        />
        <button className="w-full bg-white text-primary font-semibold py-2 rounded">
          Request Call
        </button>
      </form>
    </div>
  ...
  <div className="border-t border-white/20 py-4 text-center text-sm">
    © {new Date().getFullYear()} Keerthi Enterprises. All rights reserved.
  </div>
</footer>
